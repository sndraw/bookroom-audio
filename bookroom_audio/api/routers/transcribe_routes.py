...
def create_transcribe_routes(args: Any, api_key: Optional[str] = None):
    ...
    async def transcribe_audio(
        ...
        """
        actual_file = await _resolve_file_input(file, file_upload)
        return await _process_audio_task(actual_file, model, language, task="transcribe")
    ...
    async def _resolve_file_input(
        ...
        raise HTTPException(status_code=400, detail="No audio file provided. Use 'file' or 'file_upload'.")
