...
echo "  - STREAMING_ASR_ENGINE: ${STREAMING_ASR_ENGINE:-funasr-local}"
echo "  - STREAMING_ASR_MODEL: ${STREAMING_ASR_MODEL:-paraformer-zh-streaming}"
echo "  - STREAMING_OFFLINE_MODEL: ${STREAMING_OFFLINE_MODEL:-paraformer-zh}"
echo "  - STREAMING_VAD_MODEL: ${STREAMING_VAD_MODEL:-fsmn-vad}"
echo "  - STREAMING_PUNC_MODEL: ${STREAMING_PUNC_MODEL:-ct-punc}"
echo "  - STREAMING_CHUNK_MS: ${STREAMING_CHUNK_MS:-600}"
